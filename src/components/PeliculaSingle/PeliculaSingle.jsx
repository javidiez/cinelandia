                                ...
                                <div className='col'>
                                    <div className='d-flex justify-content-between'>
                                        ...
                                        <div className='mt-4 ms-5 d-flex align-items-start gap-3'>
                                            ...
                                            <WhatsappShareButton url={`${window.location.origin}/pelicula/${selectedMovie.id}/${selectedMovie.title.replace(/[ ]/gi, "-")}`} title={selectedMovie.title.toUpperCase()} separator=' : ' onShareWindowClose={() => window.location.replace(`${window.location.origin}/pelicula/${selectedMovie.id}/${selectedMovie.title.replace(/[ ]/gi, "-")}`)}>
